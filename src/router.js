  ...
  return (
    <Router history={history}>
      <Switch>
        ...
        <Route path="/goodsDetail/:id" exact component={dynamic({
          app,
          models: () => [
        ...
        <Route path="/cardDetail/:id" exact component={dynamic({
          app,
          models: () => [
            import('./models/card'),
          ],
        ...
        <Route path="/cardCenter" exact component={dynamic({
          app,
          models: () => [
            import('./models/card'),
          ],
        ...
        <Route path="/userInfo" exact component={dynamic({
          app,
          models: () => [
            import('./models/card'),
          ],
        ...
        <Route path="/register" exact component={dynamic({
          app,
          models: () => [
        ...
        <Route path="/forget" exact component={dynamic({
          app,
          component: () => import('./routes/forget/index')
        })} />
        <Route path="/forget2" exact component={dynamic({
          app,
          component: () => import('./routes/forget2/index')
        })} />
        <Route path="/revisePass" exact component={dynamic({
          app,
          models: () => [
            import('./models/card'),
          ],
        ...
        <Route path="/login" exact component={withRouter(dynamic({
          app,
          component: () => import('./routes/login/index')
        }))} />
        <Route path="/myself" exact component={dynamic({
          app,
          component: () => import('./routes/myself/index')
        })} />
        <Route path="/productList" exact component={dynamic({
          app,
          models: () => [
            import('./models/product'),
          ],
        ...
        <Route path="/share" exact component={dynamic({
          app,
          component: () => import('./routes/share/index')
        })} />
        <Route path="/manager" exact component={dynamic({
          app,
          component: () => import('./routes/manager/index')
        })} />
        <Route path="/reposit" exact component={dynamic({
          app,
          models: () => [
            import('./models/trade'),
            import('./models/card'),
        ...
        <Route path="/selectSellte" exact component={dynamic({
          app,
          models: () => [
            import('./models/trade'),
          ],
        ...
        <Route path="/selectBank" exact component={dynamic({
          app,
          models: () => [
            import('./models/trade'),
            import('./models/card'),
        ...
        <Route path="/tradeList" exact component={dynamic({
          app,
          models: () => [
            import('./models/trade'),
            import('./models/card'),
        ...
        <Route path="/orderDetail/:id" exact component={dynamic({
          app,
          models: () => [
            import('./models/trade'),
          ],
        ...
        <Route path="/result" exact component={dynamic({
          app,
          component: () => import('./routes/result/index')
        })} />
        <Route path="/shareYc" exact component={dynamic({
          app,
          component: () => import('./routes/shareYc/index')
        })} />
        <Route path="/follow" exact component={dynamic({
          app,
          component: () => import('./routes/follow/index')
        })} />
        <Route path="/protocal" exact component={dynamic({
          app,
